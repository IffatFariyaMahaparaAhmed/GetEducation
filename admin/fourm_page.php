        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div>
                    ...
                    $sql = $connect->query("SELECT * FROM users, discussion_forum WHERE discussion_forum.post_by = users.user_id AND discussion_forum.status = '0' ORDER BY forum_id ASC LIMIT $start_from, $limit");
                        ...
                        <div class="col-md-6 col-sm-12 mt-5 float-left">
                            <div class="card" style="height: 400px;">
                                ...
                                <div class="card-footer">
                                    <?php
                                        echo "<a><button type='button'  name='like' class='btn btn-success btn-sm'><i class='fas fa-thumbs-up'></i></button></a>";
