    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">My Post On Success Story </li>
            </ol>
                ...
                <div class="col-md-12 col-sm-12 mt-2 mb-5">
                    <div class="card">
                        <div class="card-header">
                            <h3>My Post On Success Story</h3>
                        </div>
                        <div class="card-body">
                            <?php
                            ...
                            <div class="table-responsive">
                                <table id="bootstrap-data-table" class="text-center table table-striped table-bordered">
                                    ...
                                    <?php
                                    //get my all post
                                    $sql = $connect->query("SELECT * FROM  success_story WHERE user_id = '$user_data[user_id]'");
                                    ...
                                    while ($row = mysqli_fetch_assoc($sql)){?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                if ($row['post_status'] == '1'){
                                                    echo "<a class='btn btn-danger' href='delete_fourm.php?success=$row[success_story_id]'><i class='fa fa-trash'></i> Delete</a>";
                                                }else{
                                                    echo "<button class='btn btn-success'>Approved</button>";
                                                }
                                                ?>
