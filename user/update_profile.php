                        ...
                        <div class="card-body">
                            <div class="col-md-8 col-sm-12 float-left">
                                ...
                                <div class="pb-3">
                                    ...
                                    if(isset($_SESSION['phone_length1'])){
                                        echo "
                                                <div class='alert alert-danger alert-dismissible' id='error' style='background-color: red; color: white'>
                                                    <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                                                    <span><i class='fas fa-exclamation-triangle'></i></span> ".$_SESSION['phone_length1']."
                                                </div>
                                                ";
                                        unset($_SESSION['phone_length1']);
                                    }

                                    if(isset($_SESSION['phone_length2'])){
                                        echo "
                                                <div class='alert alert-danger alert-dismissible' id='error' style='background-color: red; color: white'>
                                                    <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                                                    <span><i class='fas fa-exclamation-triangle'></i></span> ".$_SESSION['phone_length2']."
                                                </div>
                                                ";
                                        unset($_SESSION['phone_length2']);
                                    }
                                    ...
                                    if (isset($_POST['btn']))
                                    {
                                        ...
                                        if ($first_name == ''){
                                            ...
                                            $_SESSION['first_name'] ='First Name Must In Character Value';
                                        }elseif ($last_name == ''){
                                            echo "<span class='text-danger'>Enter Last Name</span>";
                                        }elseif (!preg_match('/^[a-zA-Z ]*$/', $last_name)){
                                            $_SESSION['last_name'] ='Last Name Must In Character Value';
                                        }elseif ($phone == ''){
                                            echo "<span class='text-danger'> Enter Phone Number</span>";
                                        }elseif (!preg_match('/^[0-9]*$/',$phone)){
                                           $_SESSION['phone'] = 'Phone Number Must be Numeric Value';
                                        }elseif (strlen($phone)<11){
                                           $_SESSION['phone_length1'] = 'Phone Number Must be 11 Digit';
                                        }elseif (strlen($phone)>11){
                                            $_SESSION['phone_length2'] = 'Phone Number Must be 11 Digit';
                                        }else{
                                    ...
                                    <div class="form-group col-md-6 float-left">
                                        ...
                                        <?php
                                          if ($user_data['gender'] == 'Male'){
                                              echo '<input type="radio" checked value="Male" name="gender"> Male'.' ';
                                          }else{
                                              echo '<input type="radio"  value="Male" name="gender"> Male'.' ';
                                          }

                                        if ($user_data['gender'] == 'Female'){
                                            echo '<input type="radio" checked value="Female" name="gender"> Fe-Male';
                                        }else{
                                            echo '<input type="radio"  value="Female" name="gender"> Fe-Male';
                                        }
                                        ?>
                                    </div>
