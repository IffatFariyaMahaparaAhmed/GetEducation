    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Course Files and Tutorials</li>
            </ol>
                ...
                <div class="col-md-12 col-sm-12 mt-2">
                    <div class="card">
                        <div class="card-header">
                            ...
                            ?>
                            <h3><span class="text-info"><?php echo $course_name['course_name'];?></span> File's </h3>
                        </div>
                        <div class="card-body">
                            <div class="col-md-6 col-sm-12 float-left border-right">
                                <h3 class="text-center">Course Files</h3>
                                <br/>
                                <div id="accordion">
                                    <?php
                            ...
                            <div class="col-md-6 col-sm-12 float-left">
                                <h3 class="text-center">Course Videos</h3>
                                <br/>
                                <div id="accordion_2">
                        ...
                        <div class="card-footer">
                            <a href="all_course.php" class="btn btn-info float-right"><i class="fa fa-backward"></i> Back</a>
                        </div>
                    </div>
                </div>
            </div>
