    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Manage Course Video's</li>
            </ol>
                ...
                <div class="col-md-12 col-sm-12 mt-2">
                    <div class="card">
                        <div class="card-header">
                            ...
                            ?>
                            <h3><span class="text-info"><?php echo $data['course_name'];?> </span> Video's</h3>
                        </div>
                        <div class="card-body">
                            <div class="p-2">
                                <?php
                            ...
                            <div class="table-responsive">
                                <table id="bootstrap-data-table" class="text-center table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <?php
                                    $sql_get_file = $connect->query("SELECT * FROM courses, course_video WHERE course_video.course_id = courses.course_id AND course_video.course_id = '$id'");
                                    $i = 1;
                                    while ($row = mysqli_fetch_assoc($sql_get_file)){?>
                                        <tr>
                                            ...
                                            <td style="width: 50%">
                                                <a class="text-decoration-none" href="<?php echo $row['location'];?>" target="_blank"> <i class="fa fa-download"></i> <?php echo $row['name'];?></a>
                                            </td>
                                            <td>
                                                <a class="btn btn-danger" href="delete.php?course_video=<?php echo $row['course_video_id'];?>" onclick="return confirm('Are you Sure To Delete')"><i class="fa fa-trash"></i> Delete</a>
                                            </td>
                                        </tr>
                                    <?php }
                                    ?>
